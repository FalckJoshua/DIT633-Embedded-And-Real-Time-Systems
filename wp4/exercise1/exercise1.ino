/**
 * This program turns on LEDs based on the temperature read from a sensor using interrupts on a timer.
 *
 * Work Packages 4: Exercise 1 - INTERRUPTS ON TIMER
...
const int LED_THRESHOLDS[] = {0, 10, 20, 30, 40};
